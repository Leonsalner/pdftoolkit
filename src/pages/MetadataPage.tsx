...
export function MetadataPage({ notify, isActive }: MetadataPageProps) {
  ...
  return (
    <div className="max-w-3xl mx-auto p-8 animate-in fade-in slide-in-from-bottom-2 duration-500">
      <div className="mb-6">
        <h2 className="text-2xl font-bold text-gray-900 dark:text-white">{t('metadata.title')}</h2>
        <p className="text-sm text-gray-500 dark:text-gray-400 mt-1">{t('metadata.desc')}</p>
      </div>
