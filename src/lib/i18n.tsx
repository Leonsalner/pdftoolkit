...
const translations: Translations = {
  en: {
    ...
    'split.mode.single': 'Split into single pages',
    'split.mode.every_n': 'Split every N pages',
    'split.mode.after_page': 'Split after specific page',
    'split.mode.ranges': 'Split into specific ranges',
  ...
  sk: {
    ...
    'split.mode.single': 'Rozdeliť na jednotlivé strany',
    'split.mode.every_n': 'Rozdeliť každých N strán',
    'split.mode.after_page': 'Rozdeliť po konkrétnej strane',
    'split.mode.ranges': 'Rozdeliť na špecifické rozsahy',
